...
/**
 * One-time seed content written to Firestore the first time the "room_units"/"bookings"
 * collections are found empty (fresh Firebase project). See [com.datazync.greenedgevilla.data.repository.VillaRepository.seedIfEmpty].
 */
object SeedData {

    val units: List<RoomUnit> = listOf(
        RoomUnit(
            id = "A1",
            block = "Block A",
            bhkType = "3 BHK",
